...
Referencia rápida:
- `great_dspy/specs/` → Reglas de negocio como datos (74 reglas en 6 vistas)
- `great_dspy/modules/` → Lógica del negocio (30 módulos, Python puro)
- `great_dspy/pipeline/` → Blueprint de orquestación para endpoints
