...
Las 100 reglas de negocio del sistema GREAT están codificadas como **especificaciones ejecutables** en `great_sdd/specs/`. Los agentes de IA (Claude, Codex, Copilot, Cursor) leen estos archivos, entienden las reglas, y generan código que las cumple — validado por 321 tests.
...
Desarrollador → Pasa el repo a un agente de IA
              ...
              Agente genera código backend/UI
                     ↓
              pytest tests/ → 321 tests validan que cumple las 100 reglas
                     ↓
...
5. 321 tests = 100 reglas de negocio verificadas
...
| `great_sdd/specs/allocation_specs.py` | 25 reglas, K€ rates, societes, split |
...
| `tests/` | 321 tests que verifican todo |
